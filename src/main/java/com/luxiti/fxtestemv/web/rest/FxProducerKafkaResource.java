package com.luxiti.fxtestemv.web.rest;

import com.luxiti.fxtestemv.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/fx-producer-kafka")
public class FxProducerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FxProducerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public FxProducerKafkaResource(KafkaProperties kafkaProperties) {
